...
class TestShims:
    def test_old_paths_still_import(self):
        from lib.import_size import check_import_size as a
        from lib.paired_selection import check_paired_selection as b
        from lib.run_expansion import effective_bytes as c
        from lib.sample_type_fields import strip_rejected as d
